...
const translations = {
  en: {
    ...
    text: {
      ...
      navPerformance: "Equity Strategies Performance",
          ...
          <div class="strategy-list">
            ...
            <article class="strategy-panel" id="strategy-dividends-plus">
              ...
              <div>
                ...
                <p>This portfolio is specifically constructed to include only 20-to-25 U.S.-traded stocks that pay cash dividends and is diversified with holdings across multiple economic sectors.</p>
  ...
  zh: {
    ...
    html: {
      ...
      insights: `<div class="section-heading"><p class="eyebrow">洞察</p></div><div class="card-grid card-grid--two"><article class="insight-card"><p class="card-kicker">市场评论</p><h3>每月评论即将推出</h3><p>市场观察、投资组合主题，以及面向客户和潜在客户的评论。</p></article><article class="insight-card"><p class="card-kicker">白皮书</p><h3>优质收益难觅</h3><p>关于收益策略、股息收入和总回报的投资者教育读物。</p></article></div>`,
...
const extendTranslations = () => {
  ...
  translations.es = {
    ...
    text: {
      ...
      navPerformance: "Rendimiento de Estrategias",
    ...
    html: {
      ...
      insights: `<div class="section-heading"><p class="eyebrow">Perspectivas</p></div><div class="card-grid card-grid--two"><article class="insight-card"><p class="card-kicker">Comentario de mercado</p><h3>Comentario mensual próximamente</h3><p>Observaciones de mercado, temas de cartera y comentarios para clientes y prospectos.</p></article><article class="insight-card"><p class="card-kicker">Documento técnico</p><h3>El buen rendimiento es difícil de encontrar</h3><p>Una lectura de educación para inversionistas sobre estrategias de rendimiento, ingresos por dividendos y retorno total.</p></article></div>`,
  ...
  translations.fr = {
    ...
    text: {
      ...
      navPerformance: "Performance des Stratégies",
    ...
    html: {
      ...
      insights: `<div class="section-heading"><p class="eyebrow">Analyses</p></div><div class="card-grid card-grid--two"><article class="insight-card"><p class="card-kicker">Commentaire de marché</p><h3>Commentaire mensuel à venir</h3><p>Observations de marché, thèmes de portefeuille et commentaires pour clients et prospects.</p></article><article class="insight-card"><p class="card-kicker">Livre blanc</p><h3>Un bon rendement est difficile à trouver</h3><p>Une lecture éducative pour les investisseurs sur les stratégies de rendement, le revenu de dividendes et le rendement total.</p></article></div>`,
  ...
  translations.ja = {
    ...
    html: {
      ...
      insights: `<div class="section-heading"><p class="eyebrow">インサイト</p></div><div class="card-grid card-grid--two"><article class="insight-card"><p class="card-kicker">市場コメント</p><h3>毎月のコメント近日公開</h3><p>市場観察、ポートフォリオテーマ、顧客および見込み顧客向けコメント。</p></article><article class="insight-card"><p class="card-kicker">ホワイトペーパー</p><h3>好利回りは見つけにくい</h3><p>利回り戦略、配当収入、トータルリターンに関する投資家向け教育資料。</p></article></div>`,
